...
#httpd.socket = ssl.wrap_socket(httpd.socket, certfile="ECC_prime256v1.cer", keyfile="ECC_prime256v1.key", server_side=True, cert_reqs=ssl.CERT_REQUIRED, ca_certs="./caCerts")
